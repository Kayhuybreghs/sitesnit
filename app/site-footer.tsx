  ...
  return <footer className="studio-footer">
    <div className="wrap">
      ...
      <div className="footer-directory">
        <div><a className="logo" href="/" aria-label="Sitesnit home"><BrandLogo light /></a><p>Een eigen gezicht online.<br />Webdesign, SEO & AI in Limburg.</p>{site.email ? <a className="footer-email" href={`mailto:${site.email}`}>{site.email}</a> : <span>E-mail: — · Telefoon: —</span>}</div>
